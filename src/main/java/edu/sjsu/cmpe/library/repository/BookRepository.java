...
public class BookRepository implements BookRepositoryInterface {
     ...
     */
    @Override
    public BookDetail saveBook(BookDetail newBook) {
    ...
    public void saveReviewToBook(BookDetail book ,Review review){
	...
	public Book updateBook(BookDetail updateBook ,Long authorId ,MultivaluedMap<String, String> params){
	...
	public Book updateBook(BookDetail updateBook , MultivaluedMap<String, String> params){
